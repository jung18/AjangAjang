...
const SignUp = () => {
  ...
  const handleSendSms = async () => {
    try {
      const response = await axios.post('https://i11b210.p.ssafy.io:8443/api/user/sms/send', { phone }, {
        headers: {
  ...
  const handleVerifyCode = async () => {
    try {
      const response = await axios.post('https://i11b210.p.ssafy.io:8443/api/user/sms/confirm', { phone, certificationNumber: verificationCode }, {
        headers: {
          'Authorization': `${accessToken}`
        }
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const addressResponse = await axios.post('https://i11b210.p.ssafy.io:8443/api/address/name', { addressName }, {
        headers: {
          'Authorization': `${accessToken}`,
      ...
      const url = 'https://i11b210.p.ssafy.io:8443/sign-up'; // 서버 URL
